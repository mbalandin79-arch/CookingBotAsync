...
public partial class WebhookInfo
{
    ...
    /// <summary><em>Optional</em>. A list of update types the bot is subscribed to. Defaults to all update types except <em>ChatMember</em>, <em>MessageReaction</em>, and <em>MessageReactionCount</em>.</summary>
