...
public partial class BotCommandScopeChat : BotCommandScope
{
    ...
    /// <summary>Unique identifier for the target chat or username of the target supergroup in the format <c>@username</c>. Channel direct messages chats and channel chats aren't supported.</summary>
